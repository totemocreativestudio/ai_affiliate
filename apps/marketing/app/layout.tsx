...
export const metadata:Metadata={metadataBase:new URL(site.url),title:{default:'Lumaway — Light Up Your Potential.',template:'%s | Lumaway'},description:'Ruang kerja intelligence untuk memahami data, menemukan peluang, dan mengarahkan keputusan bisnis.',robots:site.indexable?{index:true,follow:true}:{index:false,follow:false},icons:{icon:'/brand/luma-mark.png'}};
