...
export default async function PublicHome(){
 ...
 return <main>
  <header className="lw-nav"><Link href="/web/home" className="lw-brand"><img src="/luma-mark.png" alt=""/><strong>LUMAWAY<span>.</span></strong></Link><nav><Link href="#platform">Platform</Link><Link href="#workflow">Cara Kerja</Link><Link href="/web/insights">Insights</Link><Link href="/web/pricing">Pricing</Link><Link href="/app.lumaway/login">Login</Link><Link className="lw-primary-link" href="/app.lumaway/register">Buat Akun</Link></nav></header>

  <section className="lw-hero"><div><span className="lw-eyebrow">BUSINESS INTELLIGENCE OPERATING WORKSPACE</span><h1>Data berlimpah.<br/>Saatnya punya<br/><em>arah yang jelas.</em></h1><p>Hubungkan data, temukan maknanya, dan ubah insight menjadi langkah berikutnya untuk bisnis Anda.</p><div className="lw-actions"><Link className="lw-button" href="/app.lumaway/register">Mulai dengan Lumaway →</Link><Link className="lw-text-link" href="#workflow">Lihat cara kerjanya ↓</Link></div></div><div className="lw-hero-visual"><div className="lw-glow"/><div className="lw-core"><img src="/luma-mark.png" alt=""/><strong>LUMAWAY</strong><span>DATA → UNDERSTAND → ANALYZE → DECIDE → ACT → GROW</span></div><div className="lw-orbit one">AI INSIGHT</div><div className="lw-orbit two">AFFILIATE</div><div className="lw-orbit three">FINANCE</div></div></section>
