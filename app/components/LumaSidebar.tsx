...
export default function LumaSidebar({ profile, workspace, onLogout }: Props) {
  ...
  return <aside className="sidebar" id="sidebar">
    ...
    <nav className="side-nav">
      ...
      {profile.role === "admin" && <><div className="sidebar-label sidebar-label-inner">ADMINISTRATION</div><a className={activeHash === "#openai-integration" ? "active" : ""} href="#openai-integration"><span className="nav-ico">AI</span><span>OpenAI Integration</span></a><a className={activeHash === "#administration" ? "active" : ""} href="#administration"><span className="nav-ico">⚙</span><span>Admin Console</span></a></>}
    </nav>
