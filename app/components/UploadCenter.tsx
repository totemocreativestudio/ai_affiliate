...
export default function UploadCenter({ workspaceId }: Props) {
 ...
 const uploadInfo:Record<string,{title:string;destination:string;mapping:string[]}>={
   ...
   products:{title:"Master SKU / Produk",destination:"Master Data → Product Master",mapping:["SKU / Kode SKU","Product Name / Nama Produk","Category / Kategori","Selling Price / Harga Jual","Cost Price / HPP","Point per Unit / Point","Status"]},
   ...
   product_hpp:{title:"Product HPP",destination:"Master Data → Product Master",mapping:["SKU / Kode SKU","Product Name / Nama Produk","HPP / Cost Price / Harga Modal","Selling Price / Harga Jual (opsional)","Period / Periode (opsional)","Notes / Catatan"]}
 };
